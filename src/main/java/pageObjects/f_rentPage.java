...
public class f_rentPage extends base {
    ...
    By flatsForRentButton=By.xpath("/html/body/header/section[2]/div/ul/li[2]/div/div[1]/div/div[2]/div[1]/ul/li[2]/a/span");
    public f_rentPage(WebDriver driver) {
    ...
    public WebElement getflatsForRentButton() {

        return driver.findElement(flatsForRentButton);
    }
